  ...
  return (
    <View style={style}>
      <View style={styles.heightSelection}>
        ...
        <Text style={styles.value}>{height}<Text style={styles.unit}> cm</Text></Text>
        <Slider
          style={styles.slider}
...
const styles = StyleSheet.create({
  heightSelection: { ...BOX, marginVertical: 10 },
  label: { ...TEXT_LABEL },
  value: { ...TEXT_VALUE },
  unit: { fontSize: 16, color: "#848694", marginBottom: 10 },
  slider: { width: "100%", height: 40, transform: Platform.OS === "android" ? [{ scale: 1.1 }] : [] },
});
